...
export default function AboutUs() {
    ...
    return (
        <div className="min-h-screen bg-white dark:bg-fkcBlack text-gray-900 dark:text-white transition-colors duration-300">
            <div className="relative py-32 sm:py-40 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gradient-to-b dark:from-[#121212] dark:to-fkcBlack border-b border-gray-200 dark:border-fkcGold/20 text-center overflow-hidden">
                <div
                    className="absolute inset-0 bg-cover bg-center opacity-90 dark:opacity-100 pointer-events-none"
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 space-y-24">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start relative">
                    <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-6">
                        <div className="bg-gray-50 dark:bg-gradient-to-br dark:from-[#121212] dark:via-[#161616] dark:to-[#1a1a1a] border border-gray-200 dark:border-fkcGold/30 rounded-3xl p-8 shadow-2xl relative overflow-hidden text-center space-y-4">
                            <div className="absolute -right-10 -bottom-10 opacity-10 text-fkcDarkGold dark:text-fkcGold pointer-events-none">
                                <Award size={180} />
                            </div>
                            ...
                            <h3 className="text-2xl font-extrabold text-gray-900 dark:text-white tracking-tight">Successfully Providing Legal Solution</h3>
                            <div className="text-4xl font-black text-fkcDarkGold dark:text-fkcGold tracking-wider">For 3 Years</div>
                            <p className="text-xs text-gray-500 dark:text-gray-400">Trusted advisory partner for foreign businesses, investors, and diplomatic missions in Kenya and across Africa.</p>
                        </div>
                    </div>
                        ...
                        <div className="space-y-4 pt-4">
                            ...
                            <ul className="space-y-3">
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="text-fkcDarkGold dark:text-fkcGold shrink-0 mt-1" size={18} />
                                    <span className="text-sm text-gray-600 dark:text-gray-300">Simplifying the investment process to make Africa accessible and rewarding.</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="text-fkcDarkGold dark:text-fkcGold shrink-0 mt-1" size={18} />
                                    <span className="text-sm text-gray-600 dark:text-gray-300">Delivering legal solutions tailored to each client's unique goals.</span>
                                </li>
                                <li className="flex items-start gap-3">
                                    <CheckCircle2 className="text-fkcDarkGold dark:text-fkcGold shrink-0 mt-1" size={18} />
                                    <span className="text-sm text-gray-600 dark:text-gray-300">Building enduring relationships based on trust, respect and excellence.</span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div className="bg-gray-50 dark:bg-gradient-to-br dark:from-[#121212] dark:via-[#161616] dark:to-[#1a1a1a] border border-gray-200 dark:border-fkcGold/20 rounded-3xl p-8 shadow-xl hover:border-fkcDarkGold dark:hover:border-fkcGold transition h-[320px] flex flex-col justify-center overflow-hidden relative">
                        <div className={`space-y-4 absolute inset-8 flex flex-col justify-center transition-all duration-[3000ms] ease-in-out transform ${currentIndex === 0 ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-16 pointer-events-none"}`}>
                            <div className="w-12 h-12 rounded-xl bg-fkcGold/10 border border-gray-200 dark:border-fkcGold/20 flex items-center justify-center text-fkcDarkGold dark:text-fkcGold shrink-0">
                                <Target size={24} />
                            </div>
                        ...
                        <div className={`space-y-4 absolute inset-8 flex flex-col justify-center transition-all duration-[3000ms] ease-in-out transform ${currentIndex === 1 ? "opacity-100 translate-y-0" : "opacity-0 translate-y-16 pointer-events-none"}`}>
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Our Value Statement</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                    ...
                    <div className="bg-gray-50 dark:bg-gradient-to-br dark:from-[#121212] dark:via-[#161616] dark:to-[#1a1a1a] border border-gray-200 dark:border-fkcGold/20 rounded-3xl p-8 shadow-xl hover:border-fkcDarkGold dark:hover:border-fkcGold transition h-[320px] flex flex-col justify-center overflow-hidden relative">
                        ...
                        <div className={`space-y-4 absolute inset-8 flex flex-col justify-center transition-all duration-[3000ms] ease-in-out transform ${currentIndex === 1 ? "opacity-100 translate-y-0" : "opacity-0 -translate-y-16 pointer-events-none"}`}>
                            ...
                            <h3 className="text-2xl font-bold text-gray-900 dark:text-white">Our Purpose</h3>
                            <p className="text-gray-600 dark:text-gray-300 text-sm leading-relaxed">
                ...
                <div className="bg-gray-50 dark:bg-gradient-to-br dark:from-[#121212] dark:via-[#161616] dark:to-[#1a1a1a] border border-gray-200 dark:border-fkcGold/30 rounded-3xl p-8 sm:p-12 shadow-2xl">
                    <div className="space-y-6 max-w-4xl mx-auto text-center lg:text-left">
                        <h2 className="text-3xl sm:text-4xl font-extrabold text-gray-900 dark:text-white tracking-tight">
                            About the Founder
                        </h2>
                        <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base leading-relaxed">
                            <strong className="text-gray-900 dark:text-white">Franklin Cheluget</strong>, the visionary behind FKC Legal & Company Advocates, is a seasoned Advocate of the High Court of Kenya with a passion for making Africa the investment destination of choice. With a Master's degree in International Dispute Resolution from Queen Mary University of London, Franklin brings world-class expertise to every client interaction.
                        </p>
                        <p className="text-gray-600 dark:text-gray-300 text-sm sm:text-base leading-relaxed">
                ...
                <div ref={ref} className="relative bg-white dark:bg-[#121212] border border-gray-200 dark:border-fkcGold/20 rounded-3xl py-16 px-4 sm:px-6 lg:px-8 overflow-hidden shadow-2xl transition-colors duration-300">
