        ...
        <section className="bg-white dark:bg-fkcBlack py-20 px-4 sm:px-6 lg:px-8 border-t border-gray-200 dark:border-fkcGold/10 transition-colors duration-300">
            <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
                ...
                <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-28">
                    ...
                    <h2 className="text-4xl sm:text-5xl font-extrabold tracking-tight text-gray-900 dark:text-white leading-tight">
                        Ready to move? <br />
                        <span className="text-fkcDarkGold dark:text-fkcGold">Just Start, Legally.</span>
                    </h2>
                ...
                <div className="lg:col-span-7 grid grid-cols-1 sm:grid-cols-2 gap-6">
                    ...
                    >
                        <div className="space-y-3">
                            <span className="text-xs uppercase tracking-[0.2em] text-fkcDarkGold dark:text-fkcGold font-semibold">FKC Legal Academy</span>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">Training for Confidence</h3>
                        ...
                        <span className="inline-flex items-center gap-2 text-xs font-semibold uppercase tracking-wider text-fkcDarkGold dark:text-fkcGold group-hover:text-gray-900 dark:group-hover:text-white transition-colors">
                    ...
                    >
                        <div className="space-y-3">
                            <span className="text-xs uppercase tracking-[0.2em] text-fkcDarkGold dark:text-fkcGold font-semibold">Our Strategic Pillars</span>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">Creating Value</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                    ...
                    >
                        <div className="space-y-3">
                            <span className="text-xs uppercase tracking-[0.2em] text-fkcDarkGold dark:text-fkcGold font-semibold">FKC Legal Foundation</span>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">CSR as a Pillar</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
                    ...
                    >
                        <div className="space-y-3">
                            <span className="text-xs uppercase tracking-[0.2em] text-fkcDarkGold dark:text-fkcGold font-semibold">Global Footprint</span>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white tracking-tight">Continental Reach</h3>
                            <p className="text-sm text-gray-600 dark:text-gray-300 leading-relaxed">
